...
<div class="flex items-center gap-1 bg-orange-50 shadow-sm border-r-2 rounded mt-2 hover:bg-orange-100">
    <textarea v-model="commentText" class="textarea textarea-warning leading-tight placeholder:text-base  w-full bg-white focus:ring-orange-400 focus:border-orange-400 border border-orange-400" placeholder="Write your comment here"></textarea>
...
<div class="opacity-0">empty space </div>
</template>
