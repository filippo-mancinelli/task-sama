...
<Teleport to="body">
  ...
  <div v-if="popupStore.showPopup" class="relative" style="z-index: 2000;">
      <div v-if="popupStore.messageType == 'alert'" @click="()=>popupStore.setPopup(false, '', '', 'noModal')" class="fixed flex p-1 top-4 mx-6 md:right-4 md:p-4 2xl:top-20 text-md border hover:cursor-pointer border-black text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 " :class="{ 'md:top-20': popupStore.popupType == 'modal' }" role="alert">
